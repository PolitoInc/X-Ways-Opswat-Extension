...
extern "C" {
	...
	__declspec(dllexport) LONG __stdcall XT_Init(CallerInfo info, DWORD nFlags, HANDLE hMainWnd,
		void* lpReserved);
	...
	// XT_About
	__declspec(dllexport) LONG __stdcall XT_About(HANDLE hParentWnd, void* lpReserved);
	...
	// XT_ProcessItem
	//__declspec(dllexport) LONG __stdcall XT_ProcessItem(LONG nItemID, void* lpReserved);

	// XT_ProcessItemEx
	__declspec(dllexport) LONG __stdcall XT_ProcessItemEx(LONG nItemID, HANDLE hItem, void* lpReserved);
